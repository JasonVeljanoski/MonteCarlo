...
public class KnowledgeAgent implements Agent {
  ...
  private Random rand;
  private com.sun.org.apache.xalan.internal.utils.FeatureManager.State current;
  private int myIndex;
...
private Card heuristic(Card c1,Card c2,int W,int D) {
